...
SLAP_MESSAGES = [    "slaps {nick} around a bit with a large trout",    "gives {nick} a good slap",    "slaps {nick} with a wet fish",    "slaps {nick} with a rolling pin",    "slaps {nick} with a newspaper"]
